...
Website: **[sijil.infinitebarakah.com](https://sijil.infinitebarakah.com)** (static, in [`site/`](site/); every push to `main` redeploys it on Vercel). The build spec is [`docs/README.md`](docs/README.md). The session log for the judges is [`DEVIN_LOG.md`](DEVIN_LOG.md).
